...
public class SimulationProp extends aos.jack.jak.beliefset.ClosedWorld {
    ...
    public aos.jack.jak.cursor.Cursor getDepotLoc(aos.jack.jak.logic.IntegerVariable $depotX, aos.jack.jak.logic.IntegerVariable $depotY)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.SimulationProp.__complex_13 __c = new rmit.ai.clima.jackagt.data.SimulationProp.__complex_13($depotX,$depotY);
        try {
            return __c.setCursor(__c.__complex_13_getDepotLoc());
        }
    ...
    public aos.jack.jak.cursor.Cursor getGridSize(aos.jack.jak.logic.IntegerVariable $gridX, aos.jack.jak.logic.IntegerVariable $gridY)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.SimulationProp.__complex_14 __c = new rmit.ai.clima.jackagt.data.SimulationProp.__complex_14($gridX,$gridY);
        try {
            return __c.setCursor(__c.__complex_14_getGridSize());
        }
        catch (java.lang.Exception __e) {
    ...
    class __complex_13 extends aos.jack.plugin.view.rt.CleanupCursor {
        ...
        public __complex_13(aos.jack.jak.logic.IntegerVariable $depotX, aos.jack.jak.logic.IntegerVariable $depotY)
        {
            super($depotX);
            this.$depotX = $depotX;
            this.$depotY = $depotY;
        ...
        aos.jack.jak.cursor.Cursor __complex_13_getDepotLoc()
            throws java.lang.Exception
        {
            {
    ...
    class __complex_14 extends aos.jack.plugin.view.rt.CleanupCursor {
        ...
        public __complex_14(aos.jack.jak.logic.IntegerVariable $gridX, aos.jack.jak.logic.IntegerVariable $gridY)
        {
            super($gridX);
            this.$gridX = $gridX;
            this.$gridY = $gridY;
        ...
        aos.jack.jak.cursor.Cursor __complex_14_getGridSize()
            throws java.lang.Exception
        {
            {
                __local_2 = (aos.jack.jak.logic.IntegerVariable) new_variable(java.lang.Integer.TYPE);
