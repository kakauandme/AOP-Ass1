...
public class CurrentPosition extends aos.jack.jak.beliefset.ClosedWorld {
        ...
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        ...
        if (!__v0.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("CurrentPosition:get:OO: arg 0 x Incorrect Variable type");
        if (__v0.isGround()) {
            try {
                __t.x = __v0.as_int();
            }
        ...
        if (!__v1.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("CurrentPosition:get:OO: arg 1 y Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.y = __v1.as_int();
            }
    ...
    class __Cursor extends aos.jack.jak.beliefset.ClosedWorldCursor {
        ...
        public aos.jack.jak.logic.Variable x;
        public aos.jack.jak.logic.Variable y;
        public __Cursor()
        {
            __tuple = __hole;
        }
        ...
        public int match(int __ti, int __st, int __c, boolean __k, int __ind)
        {
            ...
            if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_DB) != 0) {
                ...
                aos.jack.jak.core.Jak.log.log("  x:" + x);
                aos.jack.jak.core.Jak.log.log("  y:" + y);
            }
        ...
        {
            if (x != null) 
                return x.getEnv().newChoicePoint();
            if (y != null) 
                return y.getEnv().newChoicePoint();
            return null;
        }
