...
public class GUIUpdateCell extends aos.jack.jak.plan.Plan {
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        ...
        int __local__13_2;
        rmit.ai.clima.gui.grid.GridObject __local__13_3;
        java.lang.String __local__13_4;
            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        case 15: 
                        {
                            __local__13_3 = meinformcellstatus_h.gridObject;
                            __state = 16;
                            break;
                        }
                        ...
                        case 16: 
                        {
                            __local__13_4 = __local__13_3.getContent();
                            __state = 17;
                            break;
                        }
                        //* (54) 	        if(gui.showGUI) {
                        ...
                        case 20: 
                        {
                            if (__local__13_4.equals("nogold")) 
                                __state = 21;
                             else 
                                __state = 22;
                            break;
                        ...
                        case 21: 
                        {
                            __breakLevel = 4;
                            __state = 23;
                            __local__13_0.guiInterface.removeFromGridLocation(__local__13_2,meinformcellstatus_h.gridObject,rmit.ai.clima.gui.grid.GameGraphics.getGraphicObject(rmit.ai.clima.gui.grid.GameGraphics.getGoldString()));
                            break;
                        }
                        ...
                        case 22: 
                        {
                            __breakLevel = 4;
                            __state = 23;
                            __local__13_0.guiInterface.updateGridLocation(__local__13_2,meinformcellstatus_h.gridObject,rmit.ai.clima.gui.grid.GameGraphics.getGraphicObject(__local__13_4));
                            break;
                        }
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                ...
                case 1: 
                {
                    return (bel_agentNumbers_dat.getNo(meinformcellstatus_h.from,__local__13_1));
                }
            }
            aos.jack.jak.core.Jak.error("illegal Cursor Construction");
            return null;
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                ...
                case 3: 
                {
                    return aos.util.ToObject.box(__local__13_3);
                }
                case 4: 
                {
                    return aos.util.ToObject.box(__local__13_4);
                }
                default: 
                {
